...
export default function ProducerDetailScreen() {
  ...
  const producer = {
    ...
    description:
      "Family-owned organic farm providing fresh, sustainable produce to local communities for over 30 years.",
  ...
  const products = [
    {
      ...
      unit: "per kg",
      image:
        "https://images.unsplash.com/photo-1546094096-0ec4ea203f13?w=200&h=200&fit=crop",
      category: "Vegetables",
      inStock: true,
    ...
    },
    {
      ...
      unit: "per bunch",
      image:
        "https://images.unsplash.com/photo-1618375569909-3c8616cf7733?w=200&h=200&fit=crop",
      category: "Herbs",
      inStock: true,
  ...
  const toNumber = (priceStr?: string) => {
  ...
  const handleAddToCart = (product: any) => {
    const numericPrice =
      typeof product.priceNumber === 'number' ? product.priceNumber : toNumber(product.price);
    ...
    addItem({
      ...
      priceNumber: numericPrice, // güvenli sayısal fiyat
    });
  };
...
const styles = StyleSheet.create({
  ...
  shareButton: { padding: 8, borderRadius: 20, backgroundColor: '#f0f0f0' },
  coverImage: { width, height: 200 },
  producerInfo: { backgroundColor: '#fff', padding: 20, marginBottom: 10 },
  producerHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 },
  producerTitleSection: { flex: 1 },
  producerName: { fontSize: 24, fontWeight: 'bold', color: '#333', marginBottom: 4 },
  specialty: { fontSize: 16, color: '#4CAF50', fontWeight: '600' },
  ratingSection: { alignItems: 'flex-end' },
  ratingContainer: { flexDirection: 'row', alignItems: 'center', marginBottom: 2 },
  rating: { marginLeft: 4, fontSize: 16, fontWeight: 'bold', color: '#333' },
  ...
  infoText: { marginLeft: 6, fontSize: 12, color: '#333', fontWeight: '600' },
  ...
  activeCategoryButton: { backgroundColor: '#4CAF50', borderColor: '#4CAF50' },
  categoryText: { fontSize: 14, color: '#666', fontWeight: '600' },
  activeCategoryText: { color: '#fff' },
  productsSection: { backgroundColor: '#fff', padding: 20 },
  ...
  addButton: { backgroundColor: '#4CAF50', width: 32, height: 32, borderRadius: 16, justifyContent: 'center', alignItems: 'center' },
